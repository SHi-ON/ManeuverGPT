...
- **June 2026 — Version 1.4.0 released**  
  Version 1.4.0 is now available with important quality and release improvements. See the GitHub Release [here](https://github.com/SHi-ON/ManeuverGPT/releases/latest).
