...
enrich_query_task = Task(
    description=("Elaborate and enhance the user's input to optimize the Driver Agent's task of generating maneuver parameters."),
...
create_maneuver_task = Task(
    description=('Generate precise maneuver parameters for a J-Turn maneuver based on the enriched user input.'),
...
validate_maneuver_task = Task(
    description=('Verify the generated maneuver parameters for correct format, executability, and high-level quality using Pydantic validation.'),
