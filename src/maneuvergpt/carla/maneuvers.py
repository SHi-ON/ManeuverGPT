...
def load_latest_maneuver_parameters(
    directory: str = None,
) -> Optional[ManeuverParameters]:
    """
            ...
            points.append(
                {
                    ...
                    'pitch': round(point['rotation'].pitch, 4),
                    'yaw': round(point['rotation'].yaw, 4),
...
def main():
    ...
    if args.mode == 'online':
        ...
        listener_thread = threading.Thread(
            ...
            args=(redis_client, args.maneuver_queue, maneuver_queue),
            daemon=True,
        )
